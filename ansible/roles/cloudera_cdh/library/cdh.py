...
SERVICE_INIT_COMMANDS = {
    ...
    'OOZIE-OOZIE_SERVER': [ApiService.create_oozie_db, ApiService.install_oozie_sharelib],
    'HIVE-HIVESERVER2': [ApiService.create_hive_warehouse],
    #'HIVE-HIVEMETASTORE': [ApiService.create_hive_metastore_database, ApiService.create_hive_metastore_tables],
    'YARN-JOBHISTORY': [ApiService.create_yarn_job_history_dir],
}
